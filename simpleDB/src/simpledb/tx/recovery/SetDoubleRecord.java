...
public class SetDoubleRecord implements LogRecord {
	   ...
	   /**
	    * Writes a setDouble record to the log.
	    * This log record contains the SETDOUBLE operator,
	   ...
	   public int writeToLog() {
	      Object[] rec = new Object[] {SETDOUBLE, txnum, blk.fileName(),
	   ...
	   public String toString() {
	      return "<SETDOUBLE " + txnum + " " + blk + " " + offset + " " + val + ">";
	   }
