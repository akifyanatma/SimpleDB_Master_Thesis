...
/*Bu programda Sciori DB kitabýndaki STUDENT VT istatistiksel bilgilerine uygun "studentdb" isimli 
 * bir veri tabaný oluþturulmuþtur. 
 * V(.) deðerleri için Stat bilgileri runtime'da oluþturuluyor. Çünkü md bu deðerler için yaklaþýk 
 * (1/3) deðer gonderiyor.
* VT onceden mevcutsa takrar oluþtu-mu-yor. Ancak nitelik istatistiklerini set ediyor.
* 
